...
class Boleta1(models.Model):
	...
	espanol1 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	espanol2 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	espanol3 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	espanol4 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	espanol5 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	espanolpromedio = models.DecimalField(max_digits=3, decimal_places=1,default=0.0, blank=True, null=True)
	matematicas1 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	matematicas2 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	matematicas3 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	matematicas4 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	matematicas5 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	matematicaspromedio = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	exploracion1 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	exploracion2 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	exploracion3 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	exploracion4 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	exploracion5 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	exploracionpromedio = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	formacion1 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	formacion2 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	formacion3 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	formacion4 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	formacion5 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	formacionpromedio = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	fisica1 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	fisica2 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	fisica3 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	fisica4 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	fisica5 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	fisicapromedio = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	artistica1 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	artistica2 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	artistica3 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	artistica4 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	artistica5 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
...
class Boleta3(models.Model):
	...
	matematicas5 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	matematicaspromedio = models.DecimalField(max_digits=3, decimal_places=1,default=0.0, blank=True, null=True)
	ciencias1 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	ciencias2 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	ciencias3 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	ciencias4 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	ciencias5 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	cienciaspromedio = models.DecimalField(max_digits=3, decimal_places=1,default=0.0, blank=True, null=True)
	entidad1 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	entidad2 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	entidad3 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	entidad4 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	entidad5 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
...
class Boleta4(models.Model):
	...
	ciencias5 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	cienciaspromedio = models.DecimalField(max_digits=3, decimal_places=1,default=0.0, blank=True, null=True)
	geografia1 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	geografia2 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	geografia3 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	geografia4 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	geografia5 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	geografiapromedio = models.DecimalField(max_digits=3, decimal_places=1,default=0.0, blank=True, null=True)
	historia1 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	historia2 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	historia3 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	historia4 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
	historia5 = models.DecimalField(max_digits = 3, decimal_places = 1,default=0.0, blank=True, null=True)
