...
#SECRET_KEY = 'g$)=%*kck&k6g17945v^-n(u@upt_n3xcvoof_-(6zq*f+*t)v'

#default_keys = { 'SECRET_KEY': 'vm4rl5*ymb@2&d_(gc$gb-^twq9w(u69hi--%$5xrh!xk(t%hw' }
default_keys = { 'SECRET_KEY': 'g$)=%*kck&k6g17945v^-n(u@upt_n3xcvoof_-(6zq*f+*t)v' }
...
TEMPLATE_DIRS = (
     Path(__file__).ancestor(1).child('templates')
)
...
MEDIA_ROOT = Path(__file__).ancestor(1).child('media')
MEDIA_URL = '/media/'
